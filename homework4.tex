      ...
      \item Check that the fields in (d) satisfy all of Maxwell’s equations (Eq. $9.67$).
        ...
        \textcolor{hwColor}{
          ...
          $
            ...
            \\
            \\
            \nabla.E=\dfrac{\partial}{\partial y} \left(E_0 ~ e^{-\kappa ~ z} ~ cos(kx-\omega ~ t)\right)
            \\
            \\
            \therefore ~~~ \boxed{\nabla.E=0} ~~~~ \checkmark
            \\
            ...
            \\
            \\
            \nabla.B=\dfrac{\partial}{\partial x} \left(\dfrac{E_0}{\omega} e^{-\kappa ~ z} ~ sin(kx-\omega ~ t)\right)
            +\dfrac{\partial}{\partial z} \left(\dfrac{E_0}{\omega} e^{-\kappa ~ z} ~ cos(kx-\omega ~ t)\right)
            \\
            \\
            =\dfrac{E_0}{\omega} \kappa ~ k ~ e^{-\kappa ~ z} ~ cos(kx-\omega ~ t)
            -\dfrac{E_0}{\omega} \kappa ~ k ~ e^{-\kappa ~ z} ~ cos(kx-\omega ~ t)
            \\
            \\
            \therefore ~~~ \boxed{\nabla.B=0} ~~~~ \checkmark
            ...
            \nabla \times E=\begin{vmatrix}
              ...
              0 && E_y && 0
            \end{vmatrix}
            =-\dfrac{E_0}{\omega} e^{\kappa z} \left(
              -\kappa ~ \omega  ~ cos(kx-\omega t) ~ \hat{x}+k ~ \omega ~ sin(kx-\omega ~ t) ~ \hat{z}
            \right)
            \\
            ...
            \\
            \\
            \therefore ~~~ \boxed{\nabla \times E=-\dfrac{\partial B}{\partial t}} ~~~~ \checkmark
            \\
            \\
            \rule{15cm}{1pt}
            \\
            \\
            \nabla \times B=\begin{vmatrix}
              \hat{x} && \hat{y} && \hat{z}
              \\
              \\
              \dfrac{\partial}{\partial x} && \dfrac{\partial}{\partial y} && \dfrac{\partial}{\partial z}
              ...
              B_x && 0 && B_z
            \end{vmatrix}
            =\left(\dfrac{\partial B_x}{\partial z}-\dfrac{\partial B_z}{\partial x}\right) \hat{y}
            \\
            \\
            =\left(
              -\dfrac{E_0}{\omega} ~ \kappa^2 ~ e^{-\kappa z} sin(kx-\omega t)+\dfrac{E_0}{\omega} \kappa^2 ~ e^{-\kappa z} sin(kx-\omega t)
            \right)\hat{y}
            \\
            \\
            =\dfrac{\omega^2}{c^2} \left(n_1^2 ~ sin(\theta_I)-n_1^2 ~ sin^2(\theta_I)+n_2^2\right) \dfrac{E_0}{\omega} e^{\kappa ~ z} sin(kx-\omega t) \hat{y}
            \\
            \\
            =\dfrac{n_2^2 ~ \omega^2}{c^2} \dfrac{E_0}{\omega} e^{\kappa ~ z} sin(kx-\omega t) \hat{y}
            \\
            \\
            =\omega^2 ~ \epsilon_2 ~ \mu_2 \dfrac{E_0}{\omega} e^{\kappa ~ z} sin(kx-\omega t) \hat{y}
            \\
            \\
            =\mu_2 ~ \epsilon_2 ~ E_0 ~ \omega ~ e^{-\kappa z} ~ sin(kx-\omega t) \hat{y}=\mu_2 ~ \epsilon_2 ~ \dfrac{\partial E}{\partial t}
            \\
            \\
            \\
            \therefore ~~~ \boxed{\nabla \times B=\mu_2 ~ \epsilon_2 ~ \dfrac{\partial B}{\partial t}} ~~~~ \checkmark
            \\
            \\
           $
        }
